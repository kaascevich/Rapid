// PartialRangeThroughConformancesSpec.swift
...
final class PartialRangeThroughConformancesSpec: QuickSpec {
    override class func spec() {
        ...
        it("conforms to CustomDebugStringConvertible") {
            expect(range.debugDescription).to(equal("PartialRangeThrough(...\(range.upperBound))"))
        }
    }
}
